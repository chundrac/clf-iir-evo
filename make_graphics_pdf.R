...
ratio.rates <- syn.GSS[,'(+clf,+obl.pl)'] / syn.GSS[,'(+clf,-obl.pl)']
len(ratio.rates[ratio.rates > 1])/len(ratio.rates)
len(ratio.rates[ratio.rates > 2])/len(ratio.rates)
len(ratio.rates[ratio.rates > 3])/len(ratio.rates)
len(ratio.rates[ratio.rates > 4])/len(ratio.rates)
